...
<span class="irc-name">Coherencia con la pregunta de investigación</span><span class="irc-weight">20%</span>
<span class="irc-sub">Cuant.: el instrumento opera las variables definidas en el problema. Cual.: el guion/guía captura las categorías/ejes de indagación del problema.</span>
</td>
<td class="irc-opt">
<label>
...
<td class="irc-crit-cell">
<span class="irc-name">Validación del instrumento</span><span class="irc-weight">30%</span>
<span class="irc-sub">Cuant.: aplica CVI/CVR con jueces expertos y/o checklist COSMIN. Cual.: aplica checklist COREQ o CASP en el diseño.</span>
</td>
<td class="irc-opt">
<label>
...
<td class="irc-crit-cell">
<span class="irc-name">Prueba piloto y ajustes</span><span class="irc-weight">25%</span>
<span class="irc-sub">Cuant.: ejecuta piloto y calcula fiabilidad preliminar (ej. alfa de Cronbach). Cual.: realiza entrevista/observación piloto y ajusta el guion.</span>
</td>
<td class="irc-opt">
<label>
...
<td class="irc-crit-cell">
<span class="irc-name">Consideraciones éticas</span><span class="irc-weight">15%</span>
<span class="irc-sub">Cuant.: consentimiento informado y manejo de datos, según aplique. Cual.: consentimiento informado, anonimización y manejo de datos sensibles.</span>
</td>
<td class="irc-opt">
<label>
...
<td class="irc-crit-cell">
<span class="irc-name">Calidad del documento</span><span class="irc-weight">10%</span>
<span class="irc-sub">Cuant.: describe el instrumento según STROBE. Cual.: describe el instrumento según COREQ/SRQR.</span>
</td>
<td class="irc-opt">
<label>
...
<tr class="irc" data-weight="20">
<td class="irc-crit-cell">
<span class="irc-name">Organización y limpieza de datos</span><span class="irc-weight">20%</span>
<span class="irc-sub">Cuant.: base de datos depurada y variables codificadas. Cual.: transcripciones completas y corpus documental organizado.</span>
</td>
<td class="irc-opt">
<label>
...
<tr class="irc" data-weight="25">
<td class="irc-crit-cell">
<span class="irc-name">Uso de software</span><span class="irc-weight">25%</span>
<span class="irc-sub">Cuant.: manejo de SPSS/R/Jamovi para análisis descriptivo/inferencial. Cual.: manejo de Atlas.ti/NVivo/Taguette para primer ciclo de codificación.</span>
</td>
<td class="irc-opt">
<label>
...
<tr class="irc" data-weight="30">
<td class="irc-crit-cell">
<span class="irc-name">Rigor del análisis</span><span class="irc-weight">30%</span>
<span class="irc-sub">Cuant.: selección adecuada de pruebas estadísticas según tipo de variable y diseño. Cual.: coherencia entre tipo de codificación (contenido vs. discurso) y pregunta de investigación.</span>
</td>
<td class="irc-opt">
<label>
...
<tr class="irc" data-weight="15">
<td class="irc-crit-cell">
<span class="irc-name">Documentación del proceso</span><span class="irc-weight">15%</span>
<span class="irc-sub">Cuant.: bitácora de decisiones de análisis. Cual.: diario metodológico de decisiones de codificación.</span>
</td>
<td class="irc-opt">
<label>
...
<tr class="irc" data-weight="10">
<td class="irc-crit-cell">
<span class="irc-name">Gestión autónoma del avance</span><span class="irc-weight">10%</span>
<span class="irc-sub">Cuant.: cumplimiento del cronograma de análisis propio. Cual.: cumplimiento del cronograma de codificación propio.</span>
</td>
<td class="irc-opt">
<label>
...
<tr class="irc" data-weight="30">
<td class="irc-crit-cell">
<span class="irc-name">Interpretación en relación con la pregunta</span><span class="irc-weight">30%</span>
<span class="irc-sub">Cuant.: interpreta significancia estadística y relevancia práctica/clínica. Cual.: construye categorías/patrones y los relaciona con el problema.</span>
</td>
<td class="irc-opt">
<label>
...
<tr class="irc" data-weight="20">
<td class="irc-crit-cell">
<span class="irc-name">Contextualización de los hallazgos</span><span class="irc-weight">20%</span>
<span class="irc-sub">Cuant. y Cual.: relaciona resultados/hallazgos con literatura y contexto de salud pública.</span>
</td>
<td class="irc-opt">
<label>
...
<tr class="irc" data-weight="20">
<td class="irc-crit-cell">
<span class="irc-name">Comunicación de resultados</span><span class="irc-weight">20%</span>
<span class="irc-sub">Cuant.: claridad de tablas y gráficos estadísticos. Cual.: claridad de matrices o mapas de códigos/categorías.</span>
</td>
<td class="irc-opt">
<label>
...
<tr class="irc" data-weight="15">
<td class="irc-crit-cell">
<span class="irc-name">Diálogo interparadigmático — sesión 6</span><span class="irc-weight">15%</span>
<span class="irc-sub">Cuant.: explica sus hallazgos a compañeros cualitativos y comprende los de ellos. Cual.: explica sus hallazgos a compañeros cuantitativos y comprende los de ellos.</span>
</td>
<td class="irc-opt">
<label>
...
<tr class="irc" data-weight="15">
<td class="irc-crit-cell">
<span class="irc-name">Proyección hacia el documento de grado</span><span class="irc-weight">15%</span>
<span class="irc-sub">Cuant. y Cual.: identifica implicaciones para la discusión y conclusiones de la tesis.</span>
</td>
<td class="irc-opt">
<label>
